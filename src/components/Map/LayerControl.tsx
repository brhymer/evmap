...
import { Accordion, AccordionTitle, AccordionContent, AccordionTitleProps, Icon } from 'semantic-ui-react';
            ...
            <div className="flex justify-between flex-wrap relative" >
                ...
                <AccordionContent className="w-full" active={activeIndex === 0}>
                    <input
                        ...
                        max={100}
                    />
                    <p className="text-sm" dangerouslySetInnerHTML={{ __html: accordionText }}></p>
                </AccordionContent>
            </div>
        </Accordion>
    )
